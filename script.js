...
const USERS = [
    ...
    { username: "client12b", password: "221240", expiresAt: new Date("2026-12-15") },
    { username: "client548", password: "221240", expiresAt: new Date("2026-02-11") },
    ...
    { username: "client588", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client114", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client199", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client927", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client76", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client965", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client12da", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "clientceli", password: "221240", expiresAt: new Date("2028-01-13") },
    { username: "clientre", password: "221240", expiresAt: new Date("2027-12-12") },
    { username: "client901", password: "221240", expiresAt: new Date("2026-12-12") },
    { username: "client1750", password: "221240", expiresAt: new Date("2027-12-12") }
];
